...
const SearchResult = ({ searchResult, keyword, imageErrorHandler }) => {
  ...
  return (
    <div className={css.searchResult}>
      ...
      {searchResult.length > 8 && 
        <div className={css.outerAllResults}>
          <p className={css.allResults} onMouseDown={() => history.push(`/all-results/${keyword}`)}>See all results for "{keyword}"</p>
        </div> }
    </div>
  )
}
